...
# Run analysis for each age/region combo
for age in ages:
...
results_df.to_csv("filtered_female_region_charges.csv", index=False)
...
plt.title("Estimated Insurance Cost by Region (Healthy Female, Age 18–64, ≥3 Matches, Median)")
plt.xlabel("Age")
...
plt.savefig("filtered_female_region_charge_plot.png")
plt.show()
